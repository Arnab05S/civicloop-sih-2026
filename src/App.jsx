...
const translations = {"en":{"home":"Home","explore":"Explore issues","budget":"Community budget","report":"Report an issue","hero":"See an issue.","heroEm":"Start a solution.","heroText":"CivicLoop turns everyday reports into visible action ? and gives your neighbourhood a say in what gets fixed next.","exploreLocal":"Explore local issues","live":"Live civic pulse","issues":"Issues in your area","support":"Support this cause","supportDone":"Support recorded","details":"Issue details","photo":"Incident photo","addPhoto":"Add incident photo","photoHint":"Upload a clear image of the issue (JPG, PNG or WebP; max 2 MB).","sortRecent":"Most recent","sortSupport":"Most supported","sortAttention":"Needs attention","handling":"How CivicLoop is handling this","view":"View"},"hi":{"home":"???","explore":"???????? ?????","budget":"????????? ???","report":"?????? ???? ????","hero":"?????? ??????","heroEm":"?????? ???? ?????","heroText":"CivicLoop ????????? ?? ????????? ?? ????? ???? ???? ???????? ??? ????? ???","exploreLocal":"??????? ???????? ?????","live":"???? ?????? ??????","issues":"???? ??????? ?? ????????","support":"?? ???? ?? ?????? ????","supportDone":"?????? ???? ???","details":"?????? ?? ?????","photo":"???? ?? ????","addPhoto":"???? ?? ???? ??????","photoHint":"?????? ?? ?????? ???? ????? ???? (JPG, PNG ?? WebP; ?????? 2 MB)?","sortRecent":"???? ??? ??","sortSupport":"???? ???? ???????","sortAttention":"?????? ?????","handling":"CivicLoop ?? ?????? ?? ???? ????? ??? ??","view":"?????"},"or":{"home":"???","explore":"?????? ???????","budget":"?????? ?????","report":"?????? ??????? ??????","hero":"?????? ????????","heroEm":"?????? ????? ???????","heroText":"CivicLoop ???????? ????????? ???????? ????????? ????? ????","exploreLocal":"??????? ?????? ???????","live":"????? ?????? ??????","issues":"?????? ?????? ??????","support":"??? ?????? ?????? ??????","supportDone":"?????? ?????? ????","details":"?????? ??????","photo":"????? ???","addPhoto":"????? ??? ???????","photoHint":"??????? ?????? ??? ????? ?????? (JPG, PNG ?????? WebP; ???????? 2 MB)?","sortRecent":"????? ???","sortSupport":"???????? ???????","sortAttention":"????? ?????","handling":"CivicLoop ??? ???????? ????? ??????","view":"???????"},"ta":{"home":"???????","explore":"??????????? ???????","budget":"???? ???????","report":"?????? ??????","hero":"????????? ?????????.","heroEm":"???????? ????????????.","heroText":"CivicLoop ?????? ????????? ??????????? ???????? ???????????? ???????????.","exploreLocal":"??????? ???????????? ???????","live":"????? ?????????? ???????","issues":"?????? ????? ??????????","support":"?????? ?????????? ???????????","supportDone":"????? ????? ?????????????","details":"??????? ?????????","photo":"??????? ????","addPhoto":"??????? ???????? ???????????","photoHint":"????????? ??????? ???????? ???????????? (JPG, PNG ?????? WebP; ?????????? 2 MB).","sortRecent":"??? ????????","sortSupport":"???? ?????","sortAttention":"????? ????","handling":"CivicLoop ???? ??????? ??????? ???????????","view":"???????"}};
const languageNames = {"en":"English","hi":"Hindi (??????)","or":"Odia (?????)","ta":"Tamil (?????)"};
