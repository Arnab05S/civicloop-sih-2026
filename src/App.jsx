...
const languageNames = { en: 'English', hi: 'Hindi (हिन्दी)', or: 'Odia (ଓଡ଼ିଆ)', ta: 'Tamil (தமிழ்)', bn: 'Bengali (বাংলা)', mr: 'Marathi (मराठी)', kn: 'Kannada (ಕನ್ನಡ)', te: 'Telugu (తెలుగు)', gu: 'Gujarati (ગુજરાતી)' };
Object.assign(translations, additionalUiTranslations);
Object.assign(languageNames, { bn: 'Bengali (বাংলা)', mr: 'Marathi (मराठी)', kn: 'Kannada (ಕನ್ನಡ)', te: 'Telugu (తెలుగు)', gu: 'Gujarati (ગુજરાતી)' });
const reportTranslationCopy = {
  hi: { translated: 'अनुवादित डेमो रिपोर्ट', original: 'मूल रिपोर्ट देखें', translatedButton: 'अनुवाद देखें' },
  or: { translated: 'ଅନୁବାଦିତ ଡେମୋ ରିପୋର୍ଟ', original: 'ମୂଳ ରିପୋର୍ଟ ଦେଖନ୍ତୁ', translatedButton: 'ଅନୁବାଦ ଦେଖନ୍ତୁ' },
  ta: { translated: 'மொழிபெயர்க்கப்பட்ட டெமோ புகார்', original: 'மூலப் புகாரைக் காண்க', translatedButton: 'மொழிபெயர்ப்பைக் காண்க' },
  bn: { translated: 'অনুবাদিত ডেমো রিপোর্ট', original: 'মূল রিপোর্ট দেখুন', translatedButton: 'অনুবাদ দেখুন' },
  mr: { translated: 'अनुवादित डेमो अहवाल', original: 'मूळ अहवाल पहा', translatedButton: 'अनुवाद पहा' },
  kn: { translated: 'ಅನುವಾದಿತ ಡೆಮೊ ವರದಿ', original: 'ಮೂಲ ವರದಿ ನೋಡಿ', translatedButton: 'ಅನುವಾದ ನೋಡಿ' },
  te: { translated: 'అనువదించిన డెమో నివేదిక', original: 'మూల నివేదిక చూడండి', translatedButton: 'అనువాదం చూడండి' },
  gu: { translated: 'અનુવાદિત ડેમો રિપોર્ટ', original: 'મૂળ રિપોર્ટ જુઓ', translatedButton: 'અનુવાદ જુઓ' }
};
