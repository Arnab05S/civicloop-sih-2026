...
import { seededReportTranslations } from './reportTranslations';
import { additionalUiTranslations } from './additionalUiTranslations';
...
const initialReports = [
  { id: 'CL-2026-1842', title: 'Overflowing drain near Community Hall', category: 'Drainage', area: 'Jagmohan Nagar, Bhubaneswar, Odisha', distance: '120 m', status: 'In Progress', created: 'Today, 10:24 AM', votes: 28, color: '#ff8b3d', detail: 'Drain water is overflowing onto the road after the morning rain. Pedestrians and school buses are affected.', department: 'Sanitation & Drainage', image: 'ðŸŒŠ' },
  { id: 'CL-2026-1837', title: 'Broken streetlight at Block C crossing', category: 'Streetlight', area: 'Jagmohan Nagar, Bhubaneswar, Odisha', distance: '280 m', status: 'Assigned', created: 'Yesterday', votes: 17, color: '#8f6cff', detail: 'The crossing has been dark for the last three nights. Visibility is poor after sunset.', department: 'Electrical Maintenance', image: 'ðŸ’¡' },
  { id: 'CL-2026-1828', title: 'Deep pothole on Main Market Road', category: 'Roads', area: 'Jagmohan Nagar, Bhubaneswar, Odisha', distance: '410 m', status: 'Received', created: '2 days ago', votes: 41, color: '#ef5f70', detail: 'A pothole beside the bus stop is causing traffic to swerve into the opposite lane.', department: 'Roads & Works', image: 'ðŸ•³ï¸' },
  { id: 'CL-2026-1804', title: 'Waste collection missed on 7th Lane', category: 'Waste', area: 'Saheed Nagar', distance: '650 m', status: 'Resolved', created: '4 days ago', votes: 13, color: '#2bb7a8', detail: 'Household waste has not been collected since Monday.', department: 'Solid Waste Management', image: 'â™»ï¸' }
];

const proposals = [
  { id: 1, title: 'Resurface Main Market Road', location: 'Market Road corridor', cost: 'â‚¹4.5L', votes: 284, target: 500, tag: 'Roads', color: '#ee6a52' },
  { id: 2, title: 'Install 18 solar streetlights', location: 'Block C & Community Park', cost: 'â‚¹3.1L', votes: 227, target: 500, tag: 'Safety', color: '#7d6bd9' },
  { id: 3, title: 'Upgrade storm-water drains', location: 'Jagmohan Nagar, Bhubaneswar, Phase 2', cost: 'â‚¹5.8L', votes: 193, target: 500, tag: 'Drainage', color: '#20a7a1' }
];
...
const translations = {"en":{"home":"Home","explore":"Explore issues","budget":"Community budget","report":"Report an issue","hero":"See an issue.","heroEm":"Start a solution.","heroText":"CivicLoop turns everyday reports into visible action â€” and gives your neighbourhood a say in what gets fixed next.","exploreLocal":"Explore local issues","live":"Live civic pulse","issues":"Issues in your area","support":"Support this cause","supportDone":"Support recorded","details":"Issue details","photo":"Incident photo","addPhoto":"Add incident photo","photoHint":"Upload a clear image of the issue (JPG, PNG or WebP; max 2 MB).","sortRecent":"Most recent","sortSupport":"Most supported","sortAttention":"Needs attention","handling":"How CivicLoop is handling this","view":"View"},"hi":{"home":"à¤¹à¥‹à¤®","explore":"à¤¸à¤®à¤¸à¥à¤¯à¤¾à¤à¤ à¤¦à¥‡à¤–à¥‡à¤‚","budget":"à¤¸à¤¾à¤®à¥à¤¦à¤¾à¤¯à¤¿à¤• à¤¬à¤œà¤Ÿ","report":"à¤¸à¤®à¤¸à¥à¤¯à¤¾ à¤¦à¤°à¥à¤œ à¤•à¤°à¥‡à¤‚","hero":"à¤¸à¤®à¤¸à¥à¤¯à¤¾ à¤¦à¥‡à¤–à¥‡à¤‚à¥¤","heroEm":"à¤¸à¤®à¤¾à¤§à¤¾à¤¨ à¤¶à¥à¤°à¥‚ à¤•à¤°à¥‡à¤‚à¥¤","heroText":"CivicLoop à¤°à¥‹à¤œà¤¼à¤®à¤°à¥à¤°à¤¾ à¤•à¥€ à¤°à¤¿à¤ªà¥‹à¤°à¥à¤Ÿà¥‹à¤‚ à¤•à¥‹ à¤¦à¤¿à¤–à¤¾à¤ˆ à¤¦à¥‡à¤¨à¥‡ à¤µà¤¾à¤²à¥€ à¤•à¤¾à¤°à¥à¤°à¤µà¤¾à¤ˆ à¤®à¥‡à¤‚ à¤¬à¤¦à¤²à¤¤à¤¾ à¤¹à¥ˆà¥¤","exploreLocal":"à¤¸à¥à¤¥à¤¾à¤¨à¥€à¤¯ à¤¸à¤®à¤¸à¥à¤¯à¤¾à¤à¤ à¤¦à¥‡à¤–à¥‡à¤‚","live":"à¤²à¤¾à¤‡à¤µ à¤¨à¤¾à¤—à¤°à¤¿à¤• à¤¸à¥à¤¥à¤¿à¤¤à¤¿","issues":"à¤†à¤ªà¤•à¥‡ à¤•à¥à¤·à¥‡à¤¤à¥à¤° à¤•à¥€ à¤¸à¤®à¤¸à¥à¤¯à¤¾à¤à¤","support":"à¤‡à¤¸ à¤•à¤¾à¤°à¤£ à¤•à¤¾ à¤¸à¤®à¤°à¥à¤¥à¤¨ à¤•à¤°à¥‡à¤‚","supportDone":"à¤¸à¤®à¤°à¥à¤¥à¤¨ à¤¦à¤°à¥à¤œ à¤¹à¥à¤†","details":"à¤¸à¤®à¤¸à¥à¤¯à¤¾ à¤•à¤¾ à¤µà¤¿à¤µà¤°à¤£","photo":"à¤˜à¤Ÿà¤¨à¤¾ à¤•à¥€ à¤«à¥‹à¤Ÿà¥‹","addPhoto":"à¤˜à¤Ÿà¤¨à¤¾ à¤•à¥€ à¤«à¥‹à¤Ÿà¥‹ à¤œà¥‹à¤¡à¤¼à¥‡à¤‚","photoHint":"à¤¸à¤®à¤¸à¥à¤¯à¤¾ à¤•à¥€ à¤¸à¥à¤ªà¤·à¥à¤Ÿ à¤«à¥‹à¤Ÿà¥‹ à¤…à¤ªà¤²à¥‹à¤¡ à¤•à¤°à¥‡à¤‚à¥¤","sortRecent":"à¤¸à¤¬à¤¸à¥‡ à¤¹à¤¾à¤² à¤•à¥€","sortSupport":"à¤¸à¤¬à¤¸à¥‡ à¤…à¤§à¤¿à¤• à¤¸à¤®à¤°à¥à¤¥à¤¿à¤¤","sortAttention":"à¤¤à¤¤à¥à¤•à¤¾à¤² à¤§à¥à¤¯à¤¾à¤¨","handling":"CivicLoop à¤‡à¤¸ à¤¸à¤®à¤¸à¥à¤¯à¤¾ à¤•à¥‹ à¤•à¥ˆà¤¸à¥‡ à¤¸à¤‚à¤­à¤¾à¤² à¤°à¤¹à¤¾ à¤¹à¥ˆ","view":"à¤¦à¥‡à¤–à¥‡à¤‚"},"or":{"home":"à¬¹à­‹à¬®","explore":"à¬¸à¬®à¬¸à­à­Ÿà¬¾ à¬¦à­‡à¬–à¬¨à­à¬¤à­","budget":"à¬¸à¬®à­à¬¦à¬¾à­Ÿ à¬¬à¬œà­‡à¬Ÿà­","report":"à¬¸à¬®à¬¸à­à­Ÿà¬¾ à¬°à¬¿à¬ªà­‹à¬°à­à¬Ÿ à¬•à¬°à¬¨à­à¬¤à­","hero":"à¬¸à¬®à¬¸à­à­Ÿà¬¾ à¬¦à­‡à¬–à¬¨à­à¬¤à­à¥¤","heroEm":"à¬¸à¬®à¬¾à¬§à¬¾à¬¨ à¬†à¬°à¬®à­à¬­ à¬•à¬°à¬¨à­à¬¤à­à¥¤","heroText":"CivicLoop à¬¦à­ˆà¬¨à¬¨à­à¬¦à¬¿à¬¨ à¬°à¬¿à¬ªà­‹à¬°à­à¬Ÿà¬•à­ à¬¦à­ƒà¬¶à­à­Ÿà¬®à¬¾à¬¨ à¬•à¬¾à¬°à­à¬¯à­à­Ÿà¬°à­‡ à¬ªà¬°à¬¿à¬£à¬¤ à¬•à¬°à­‡à¥¤","exploreLocal":"à¬¸à­à¬¥à¬¾à¬¨à­€à­Ÿ à¬¸à¬®à¬¸à­à­Ÿà¬¾ à¬¦à­‡à¬–à¬¨à­à¬¤à­","live":"à¬²à¬¾à¬‡à¬­à­ à¬¨à¬¾à¬—à¬°à¬¿à¬• à¬¸à­à¬¥à¬¿à¬¤à¬¿","issues":"à¬†à¬ªà¬£à¬™à­à¬• à¬…à¬žà­à¬šà¬³à¬° à¬¸à¬®à¬¸à­à­Ÿà¬¾","support":"à¬à¬¹à¬¿ à¬•à¬¾à¬°à¬£à¬•à­ à¬¸à¬®à¬°à­à¬¥à¬¨ à¬•à¬°à¬¨à­à¬¤à­","supportDone":"à¬¸à¬®à¬°à­à¬¥à¬¨ à¬°à­‡à¬•à¬°à­à¬¡ à¬¹à­‡à¬²à¬¾","details":"à¬¸à¬®à¬¸à­à­Ÿà¬¾ à¬¬à¬¿à¬¬à¬°à¬£à­€","photo":"à¬˜à¬Ÿà¬£à¬¾à¬° à¬«à¬Ÿà­‹","addPhoto":"à¬˜à¬Ÿà¬£à¬¾à¬° à¬«à¬Ÿà­‹ à¬¯à­‹à¬¡à¬¨à­à¬¤à­","photoHint":"à¬¸à¬®à¬¸à­à­Ÿà¬¾à¬° à¬¸à­à¬ªà¬·à­à¬Ÿ à¬«à¬Ÿà­‹ à¬…à¬ªà¬²à­‹à¬¡ à¬•à¬°à¬¨à­à¬¤à­à¥¤","sortRecent":"à¬¸à¬¬à­à¬ à­ à¬¨à­‚à¬†","sortSupport":"à¬¸à¬°à­à¬¬à¬¾à¬§à¬¿à¬• à¬¸à¬®à¬°à­à¬¥à¬¿à¬¤","sortAttention":"à¬œà¬°à­à¬°à­€ à¬§à­à­Ÿà¬¾à¬¨","handling":"CivicLoop à¬à¬¹à¬¿ à¬¸à¬®à¬¸à­à­Ÿà¬¾à¬•à­ à¬•à¬¿à¬ªà¬°à¬¿ à¬¦à­‡à¬–à­à¬›à¬¿","view":"à¬¦à­‡à¬–à¬¨à­à¬¤à­"},"ta":{"home":"à®®à¯à®•à®ªà¯à®ªà¯","explore":"à®ªà¯à®•à®¾à®°à¯à®•à®³à¯ˆà®ªà¯ à®ªà®¾à®°à¯à®•à¯à®•","budget":"à®šà®®à¯‚à®• à®ªà®Ÿà¯à®œà¯†à®Ÿà¯","report":"à®ªà¯à®•à®¾à®°à¯ à®…à®³à®¿à®•à¯à®•","hero":"à®šà®¿à®•à¯à®•à®²à¯ˆà®•à¯ à®•à®¾à®£à¯à®™à¯à®•à®³à¯.","heroEm":"à®¤à¯€à®°à¯à®µà¯ˆà®¤à¯ à®¤à¯Šà®Ÿà®™à¯à®•à¯à®™à¯à®•à®³à¯.","heroText":"CivicLoop à®…à®©à¯à®±à®¾à®Ÿ à®ªà¯à®•à®¾à®°à¯à®•à®³à¯ˆ à®•à®£à¯à®£à¯à®•à¯à®•à¯à®¤à¯ à®¤à¯†à®°à®¿à®¯à¯à®®à¯ à®¨à®Ÿà®µà®Ÿà®¿à®•à¯à®•à¯ˆà®¯à®¾à®• à®®à®¾à®±à¯à®±à¯à®•à®¿à®±à®¤à¯.","exploreLocal":"à®‰à®³à¯à®³à¯‚à®°à¯ à®šà®¿à®•à¯à®•à®²à¯à®•à®³à¯ˆà®ªà¯ à®ªà®¾à®°à¯à®•à¯à®•","live":"à®¨à¯‡à®°à®Ÿà®¿ à®•à¯à®Ÿà®¿à®®à®•à¯à®•à®³à¯ à®¨à®¿à®²à®µà®°à®®à¯","issues":"à®‰à®™à¯à®•à®³à¯ à®ªà®•à¯à®¤à®¿ à®šà®¿à®•à¯à®•à®²à¯à®•à®³à¯","support":"à®‡à®¨à¯à®¤à®•à¯ à®•à¯‹à®°à®¿à®•à¯à®•à¯ˆà®¯à¯ˆ à®†à®¤à®°à®¿à®•à¯à®•à®µà¯à®®à¯","supportDone":"à®†à®¤à®°à®µà¯ à®ªà®¤à®¿à®µà¯ à®šà¯†à®¯à¯à®¯à®ªà¯à®ªà®Ÿà¯à®Ÿà®¤à¯","details":"à®šà®¿à®•à¯à®•à®²à¯ à®µà®¿à®µà®°à®™à¯à®•à®³à¯","photo":"à®šà®®à¯à®ªà®µà®ªà¯ à®ªà®Ÿà®®à¯","addPhoto":"à®šà®®à¯à®ªà®µà®ªà¯ à®ªà®Ÿà®¤à¯à®¤à¯ˆà®šà¯ à®šà¯‡à®°à¯à®•à¯à®•à®µà¯à®®à¯","photoHint":"à®šà®¿à®•à¯à®•à®²à®¿à®©à¯ à®¤à¯†à®³à®¿à®µà®¾à®© à®ªà®Ÿà®¤à¯à®¤à¯ˆà®ªà¯ à®ªà®¤à®¿à®µà¯‡à®±à¯à®±à®µà¯à®®à¯.","sortRecent":"à®®à®¿à®• à®…à®£à¯à®®à¯ˆà®¯à®¤à¯","sortSupport":"à®…à®¤à®¿à®• à®†à®¤à®°à®µà¯","sortAttention":"à®•à®µà®©à®®à¯ à®¤à¯‡à®µà¯ˆ","handling":"CivicLoop à®‡à®¨à¯à®¤ à®šà®¿à®•à¯à®•à®²à¯ˆ à®Žà®µà¯à®µà®¾à®±à¯ à®•à¯ˆà®¯à®¾à®³à¯à®•à®¿à®±à®¤à¯","view":"à®ªà®¾à®°à¯à®•à¯à®•"}};
const languageNames = {"en":"English","hi":"Hindi (à¤¹à¤¿à¤¨à¥à¤¦à¥€)","or":"Odia (à¬“à¬¡à¬¼à¬¿à¬†)","ta":"Tamil (à®¤à®®à®¿à®´à¯)"};
Object.assign(translations, additionalUiTranslations);
Object.assign(languageNames, { bn: 'Bengali (à¦¬à¦¾à¦‚à¦²à¦¾)', mr: 'Marathi (à¤®à¤°à¤¾à¤ à¥€)', kn: 'Kannada (à²•à²¨à³à²¨à²¡)', te: 'Telugu (à°¤à±†à°²à±à°—à±)', gu: 'Gujarati (àª—à«àªœàª°àª¾àª¤à«€)' });
const reportTranslationCopy = {
  hi: { translated: 'à¤…à¤¨à¥à¤µà¤¾à¤¦à¤¿à¤¤ à¤¡à¥‡à¤®à¥‹ à¤°à¤¿à¤ªà¥‹à¤°à¥à¤Ÿ', original: 'à¤®à¥‚à¤² à¤°à¤¿à¤ªà¥‹à¤°à¥à¤Ÿ à¤¦à¥‡à¤–à¥‡à¤‚', translatedButton: 'à¤…à¤¨à¥à¤µà¤¾à¤¦ à¤¦à¥‡à¤–à¥‡à¤‚' },
  or: { translated: 'à¬…à¬¨à­à¬¬à¬¾à¬¦à¬¿à¬¤ à¬¡à­‡à¬®à­‹ à¬°à¬¿à¬ªà­‹à¬°à­à¬Ÿ', original: 'à¬®à­‚à¬³ à¬°à¬¿à¬ªà­‹à¬°à­à¬Ÿ à¬¦à­‡à¬–à¬¨à­à¬¤à­', translatedButton: 'à¬…à¬¨à­à¬¬à¬¾à¬¦ à¬¦à­‡à¬–à¬¨à­à¬¤à­' },
  ta: { translated: 'à®®à¯Šà®´à®¿à®ªà¯†à®¯à®°à¯à®•à¯à®•à®ªà¯à®ªà®Ÿà¯à®Ÿ à®Ÿà¯†à®®à¯‹ à®ªà¯à®•à®¾à®°à¯', original: 'à®®à¯‚à®²à®ªà¯ à®ªà¯à®•à®¾à®°à¯ˆà®•à¯ à®•à®¾à®£à¯à®•', translatedButton: 'à®®à¯Šà®´à®¿à®ªà¯†à®¯à®°à¯à®ªà¯à®ªà¯ˆà®•à¯ à®•à®¾à®£à¯à®•' },
  bn: { translated: 'à¦…à¦¨à§à¦¬à¦¾à¦¦à¦¿à¦¤ à¦¡à§‡à¦®à§‹ à¦°à¦¿à¦ªà§‹à¦°à§à¦Ÿ', original: 'à¦®à§‚à¦² à¦°à¦¿à¦ªà§‹à¦°à§à¦Ÿ à¦¦à§‡à¦–à§à¦¨', translatedButton: 'à¦…à¦¨à§à¦¬à¦¾à¦¦ à¦¦à§‡à¦–à§à¦¨' },
  mr: { translated: 'à¤…à¤¨à¥à¤µà¤¾à¤¦à¤¿à¤¤ à¤¡à¥‡à¤®à¥‹ à¤…à¤¹à¤µà¤¾à¤²', original: 'à¤®à¥‚à¤³ à¤…à¤¹à¤µà¤¾à¤² à¤ªà¤¹à¤¾', translatedButton: 'à¤…à¤¨à¥à¤µà¤¾à¤¦ à¤ªà¤¹à¤¾' },
  kn: { translated: 'à²…à²¨à³à²µà²¾à²¦à²¿à²¤ à²¡à³†à²®à³Š à²µà²°à²¦à²¿', original: 'à²®à³‚à²² à²µà²°à²¦à²¿ à²¨à³‹à²¡à²¿', translatedButton: 'à²…à²¨à³à²µà²¾à²¦ à²¨à³‹à²¡à²¿' },
  te: { translated: 'à°…à°¨à±à°µà°¦à°¿à°‚à°šà°¿à°¨ à°¡à±†à°®à±‹ à°¨à°¿à°µà±‡à°¦à°¿à°•', original: 'à°®à±‚à°² à°¨à°¿à°µà±‡à°¦à°¿à°• à°šà±‚à°¡à°‚à°¡à°¿', translatedButton: 'à°…à°¨à±à°µà°¾à°¦à°‚ à°šà±‚à°¡à°‚à°¡à°¿' },
  gu: { translated: 'àª…àª¨à«àªµàª¾àª¦àª¿àª¤ àª¡à«‡àª®à«‹ àª°àª¿àªªà«‹àª°à«àªŸ', original: 'àª®à«‚àª³ àª°àª¿àªªà«‹àª°à«àªŸ àªœà«àª“', translatedButton: 'àª…àª¨à«àªµàª¾àª¦ àªœà«àª“' }
};
const localizeReport = (report, language) => {
  if (language === 'en') return report;
  const key = String(report.id || '').match(/(\d{4})$/)?.[1];
  const translation = key && seededReportTranslations[language]?.[key];
  return translation ? { ...report, title: translation.title, detail: translation.detail, isTranslated: true } : report;
};
...
function Lifecycle({ status }) { const current = Math.max(0, lifecycleSteps.indexOf(status)); return <div className="mini-lifecycle" aria-label={`Issue lifecycle: ${status}`}>{lifecycleSteps.map((step, index) => <span key={step} className={index <= current ? 'complete' : ''}><i>{index < current ? 'âœ“' : index + 1}</i><b>{step}</b></span>)}</div>; }
...
export default function App() {
  ...
  return <div className="app-shell" lang={language}>
    ...
    {view === 'home' && <Home reports={reports} setView={setView} openReport={openReport} vote={vote} votes={votes} heroParallax={heroParallax} t={t} language={language}/>} 
    {view === 'reports' && <Explore reports={sortedReports} query={query} setQuery={setQuery} openReport={openReport} sortMode={sortMode} cycleSort={cycleSort} selectReport={setSelectedReport} t={t} language={language}/>} 
    ...
    {modal && <ReportModal form={form} setForm={setForm} close={() => setModal(false)} submit={submitReport} reports={reports} t={t} language={language}/>} 
    {selectedReport && <ReportDetail report={selectedReport} close={() => setSelectedReport(null)} support={() => supportReport(selectedReport.id)} supported={Boolean(supportedReports[selectedReport.id])} t={t} language={language}/>} 
    {toast && <div className="toast"><CheckCircle2 size={18}/>{toast}<button onClick={() => setToast('')}><X size={16}/></button></div>}
  </div>;
}

function Home({ reports, setView, openReport, vote, votes, heroParallax, t, language }) {
  ...
  return <main>
    ...
    <motion.section className="metrics" initial={{opacity:0,y:24}} whileInView={{opacity:1,y:0}} viewport={{once:true,amount:.35}} transition={{duration:.45}}><div><CountUp value={1284}/><span>issues reported</span></div><div><CountUp value={78} suffix="%"/><span>resolved this quarter</span></div><div><strong>â‚¹18.6L</strong><span>community budget voted</span></div><div><CountUp value={3950}/><span>neighbours engaged</span></div></motion.section>
    <motion.section className="section recent-section" initial={{opacity:0,y:28}} whileInView={{opacity:1,y:0}} viewport={{once:true,amount:.2}} transition={{duration:.5}}><div className="section-heading"><div><span className="eyebrow">Across India, locally accountable</span><h2>What communities are reporting</h2><p>Live civic signals from Bhubaneswar, Mumbai, New Delhi and Chennai.</p></div><button className="text-button" onClick={() => setView('reports')}>View all issues <ArrowRight size={17}/></button></div><div className="report-grid">{recent.map(r => <ReportCard key={r.id} report={r} language={language} />)}</div></motion.section>
    <motion.section className="section hotspot-wrap" initial={{opacity:0,y:32}} whileInView={{opacity:1,y:0}} viewport={{once:true,amount:.18}} transition={{duration:.55}}><div className="hotspot-graphic"><div className="map-label label-a">Market Road <b>7 reports</b></div><div className="map-label label-b">Community Hall <b>5 reports</b></div><div className="map-label label-c">7th Lane <b>3 reports</b></div><div className="hotspot hot-a"></div><div className="hotspot hot-b"></div><div className="hotspot hot-c"></div><div className="map-lines"></div></div><div className="hotspot-copy"><span className="eyebrow"><Flame size={15}/> Evidence, not guesswork</span><h2>Spot the pattern.<br/>Fix the root cause.</h2><p>When reports cluster, CivicLoop brings the evidence together â€” helping the city prioritize the infrastructure that will make the biggest difference.</p><ul><li><span className="bullet teal"></span>Recurring issues mapped in real time</li><li><span className="bullet purple"></span>Clear evidence for better public spending</li><li><span className="bullet orange"></span>Open progress from report to resolution</li></ul><button className="button outline" onClick={() => setView('reports')}>See neighbourhood insights <ArrowRight size={17}/></button></div></motion.section>
...
function ReportCard({ report, language = 'en' }) { const display = localizeReport(report, language); return <motion.article className="report-card" initial={{opacity:0,y:18}} whileInView={{opacity:1,y:0}} whileHover={{y:-6,scale:1.01}} viewport={{once:true,amount:.2}} transition={{duration:.32}}><div className="report-visual" style={{background: `${report.color}16`}}><span style={{background: report.color}}>{report.image}</span><div className="category-label" style={{color: report.color}}>{display.category}</div></div><div className="report-body"><div className="report-status"><StatusPill status={report.status}/><span>{report.created}</span></div><h3>{display.title}</h3><p><MapPin size={14}/>{report.area} Â· {report.distance}</p><Lifecycle status={report.status}/><div className="report-footer"><span><ThumbsUp size={15}/>{report.votes} neighbours</span><button>Details <ChevronRight size={15}/></button></div></div></motion.article> }

function Explore({ reports, query, setQuery, openReport, sortMode, cycleSort, selectReport, t, language }) { const sortLabel = sortMode === 'recent' ? t('sortRecent') : sortMode === 'support' ? t('sortSupport') : t('sortAttention'); return <main className="page"><div className="page-heading"><div><span className="eyebrow">{t('live')}</span><h1>{t('issues')}</h1><p>Every report is visible. Every update leaves a trail.</p></div><button className="button primary" onClick={openReport}><Plus size={19}/>{t('report')}</button></div><div className="explore-layout"><aside className="filters"><div className="searchbox"><Search size={18}/><input value={query} onChange={e=>setQuery(e.target.value)} placeholder="Search reports"/></div><h4>Issue category</h4>{categories.map((c,i)=><label key={c}><input type="checkbox" defaultChecked={i < 4}/><span>{c}</span><b>{[12,8,7,4,3,2][i]}</b></label>)}<h4>Report status</h4>{['Received','Assigned','In Progress','Resolved'].map(s=><label key={s}><input type="checkbox" defaultChecked/><StatusPill status={s}/></label>)}<button className="text-button" onClick={()=>setQuery('')}>Clear filters</button></aside><section className="issues-list"><div className="list-top"><b>{reports.length} reports nearby</b><span>Sorted by: <button onClick={cycleSort} aria-label="Change issue sort order">{sortLabel} <ChevronRight size={14}/></button></span></div>{reports.map(r=>{ const display = localizeReport(r, language); return <div className="issue-row" key={r.id}><div className="issue-icon" style={{background:`${r.color}18`, color:r.color}}>{r.image}</div><div className="issue-content"><div><StatusPill status={r.status}/><small>{r.id}</small>{display.isTranslated && <em className="translation-chip">{reportTranslationCopy[language]?.translated}</em>}</div><h3>{display.title}</h3><p><MapPin size={14}/>{r.area} Â· {r.distance} <span>Â·</span> Routed to {r.department}</p></div><div className="issue-row-right"><span><ThumbsUp size={15}/>{r.votes}</span><button onClick={()=>selectReport(r)}>{t('view')} <ChevronRight size={16}/></button></div></div>})}</section><IssueMap reports={reports}/></div></main> }

function ReportDetail({ report, close, support, supported, t, language }) {
  const [showOriginal, setShowOriginal] = useState(false);
  const translated = localizeReport(report, language);
  const display = showOriginal ? report : translated;
  const copy = reportTranslationCopy[language];
  return <div className="modal-backdrop" onMouseDown={close}><section className="modal report-detail" onMouseDown={e=>e.stopPropagation()} aria-label="Issue details"><div className="modal-head"><div><span className="eyebrow"><MapPin size={14}/>{t('details')}</span><h2>{display.title}</h2></div><button aria-label="Close issue details" onClick={close}><X size={20}/></button></div><div className="detail-content">{translated.isTranslated && <div className="translation-note"><span>{copy?.translated}</span><button onClick={() => setShowOriginal(value => !value)}>{showOriginal ? copy?.translatedButton : copy?.original}</button></div>}<div className="detail-meta"><StatusPill status={report.status}/><span>{report.id}</span><span><MapPin size={14}/>{report.area}</span></div><p>{display.detail}</p>{report.incident_image && <figure className="detail-photo"><img src={report.incident_image} alt="Incident evidence provided with the report"/><figcaption>{t('photo')}</figcaption></figure>}<div className="detail-route"><ClipboardCheck size={19}/><div><b>{t('handling')}</b><span>This report is routed to {report.department}. Its visible lifecycle helps residents follow the issue from report to resolution.</span></div></div><div className="detail-support"><div><ThumbsUp size={19}/><span><b>{report.votes} neighbours support this</b><small>Community support helps show the scale of the problem.</small></span></div><button className={`button ${supported ? 'voted' : 'primary'}`} onClick={support}>{supported ? <><CheckCircle2 size={17}/>{t('supportDone')}</> : <><Heart size={17}/>{t('support')}</>}</button></div></div></section></div>}
...
function iconFor(c){return ({Roads:'ðŸ›£ï¸',Drainage:'ðŸŒŠ',Streetlight:'ðŸ’¡',Waste:'â™»ï¸',Water:'ðŸ’§'})[c]||'ðŸ“'}
